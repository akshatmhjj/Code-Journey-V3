        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "flex-start", gap: 0 }}>
          ...
          <main className="wd-main" style={{ flex: 1, minWidth: 0, paddingTop: 44, paddingBottom: 100 }}>
            ...
            <section id="html" className="wd-sec" style={{ marginBottom: 0 }}>
              ...
              <CodeWin accent="#f97316" T={T} title="HTML - basics to full structure" code={`<!-- 1. Heading -->
<h1>Hello World</h1>
  ...
  <body>
    ...
    <a href="#">See my work</a>
            ...
            <section id="css" className="wd-sec" style={{ marginBottom: 0 }}>
              ...
              <CodeWin accent="#818cf8" T={T} title="CSS - basics to layout" code={`/* 1. Change text color */
h1 {
  color: red;
}
...
.card:hover {
  transform: translateY(-5px);
            ...
            <section id="javascript" className="wd-sec" style={{ marginBottom: 0 }}>
              ...
              <CodeWin accent="#f7df1e" T={T} title="JavaScript - basics to real usage" code={`// 1. Variable
let name = "Alex";
...
getData();`} />
            ...
            <section id="typescript" className="wd-sec" style={{ marginBottom: 0 }}>
              ...
              <CodeWin accent="#60a5fa" T={T} title="TypeScript - basics to structure" code={`// 1. Basic type
...
function greet(user: User) {
  return "Hello " + user.name;
            ...
            <section id="react" className="wd-sec" style={{ marginBottom: 0 }}>
              ...
              <CodeWin accent="#61dafb" T={T} title="React - basics to component" code={`// 1. Simple component
function App() {
  return <h1>Hello</h1>;
}
...
function UserCard({ name }) {
  return <div>{name}</div>;
            ...
            <section id="node" className="wd-sec" style={{ marginBottom: 0 }}>
              ...
              <CodeWin accent="#4ade80" T={T} title="Node.js - basics to API" code={`// 1. Basic server
