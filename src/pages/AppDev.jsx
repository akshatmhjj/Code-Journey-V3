        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "flex-start", gap: 0 }}>
          ...
          <main className="ad-main" style={{ flex: 1, minWidth: 0, paddingTop: 44, paddingBottom: 100 }}>
            ...
            <section id="dart" className="ad-sec">
              ...
              <CodeWin accent="#5eead4" lang="dart" T={T} title="Dart - basics to real usage" code={`// 1. Variable
var name = "Alex";
...
fetchData();`} />
            ...
            <section id="flutter" className="ad-sec">
              ...
              <CodeWin accent="#38bdf8" lang="dart" T={T} title="Flutter - basics to UI" code={`// 1. Basic widget
      ...
      home: Scaffold(
        body: Center(child: Text("Hello App")),
            ...
            <section id="kotlin" className="ad-sec">
              ...
              <CodeWin accent="#a78bfa" lang="kotlin" T={T} title="Kotlin - basics to compose" code={`// 1. Variable
val name = "Alex"
...
fun App() {
  Text("Hello Kotlin")
            ...
            <section id="swift" className="ad-sec">
              ...
              <CodeWin accent="#f97316" lang="swift" T={T} title="Swift - basics to SwiftUI" code={`// 1. Variable
let name = "Alex"
  ...
  var body: some View {
    Text("Hello Swift")
            ...
            <section id="rn" className="ad-sec">
              ...
              <CodeWin accent="#61dafb" lang="js" T={T} title="React Native - basics to app" code={`// 1. Basic component
