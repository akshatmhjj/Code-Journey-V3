...
const FAQ_DATA = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Zero. Code Journey is specifically designed for people who have never written a line of code. Every concept is explained using plain-language analogies, and every topic builds on the one before it — nothing assumes knowledge you haven't been given yet.",
      },
      {
        q: "Is Code Journey free?",
        a: "Yes — getting started is completely free. Create an account, pick a track, and begin learning immediately. No credit card required, no trial period.",
      },
      {
        q: "How is this different from YouTube tutorials or Udemy courses?",
        a: "YouTube and Udemy are excellent — but they are built for people who already know what they want to learn. Code Journey is built for the step before that: discovering your direction, getting comfortable with the basics, and building enough confidence to engage with those platforms without feeling lost.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "Web Development covers the technologies that power websites and web apps — HTML, CSS, JavaScript, TypeScript, React, and Node.js. App Development covers mobile and cross-platform apps — Flutter, Dart, Kotlin, Swift, and React Native. Data Science covers analysis and machine learning — Python, Pandas, SQL, statistics, and ML with scikit-learn. Each track has its own stage-by-stage roadmap.",
      },
      {
        q: "Can I switch tracks after I start?",
        a: "Yes. Your progress is saved per track. You can explore all three at your own pace and switch freely. Many learners dip into multiple tracks before committing to one — that is exactly what Code Journey is designed for.",
      },
      {
        q: "Which track should I pick if I don't know what I want?",
        a: "Start with Web Development. It is the most immediately visual — you see results in a browser almost instantly — which makes it the easiest track for beginners to stay motivated on. You can always branch into App Development or Data Science once you have some momentum and a better sense of what excites you.",
      },
    ],
  },
  // ── IDE & Code Runner — coming in a future release ──────────────────────
  // {
  ...
  //   ],
  // },
  // ── AI Tutor — coming in a future release ───────────────────────────────
  // {
  //   category: "AI Tutor",
  //   color: "#22c55e",
  //   items: [
  ...
  //       a: "No. The Tutor follows a three-rung hint ladder: first a conceptual nudge, then a structural hint, then a partial implementation if you are still stuck. The goal is understanding, not completion.",
  //     },
  //   ],
  // },
  {
    ...
    items: [
      {
        ...
        a: "Yes. Your notes, tasks, and activity are all saved to your account and synced across devices. Exercise completions and XP tracking are being built alongside the full progress system and will be live in an upcoming release.",
      },
      {
        q: "What are streaks?",
        a: "A streak tracks how many consecutive days you have been active on the platform. Log in and engage with any part of Code Journey — reading a track, completing a note, working through the roadmap — to keep your streak alive. Full XP earning will arrive together with the exercises system in a future update.",
      },
      {
        q: "What is XP and when does it launch?",
        a: "XP (experience points) is the platform's progression system. You will earn XP by completing exercises, maintaining streaks, and finishing roadmap stages. It is being built in parallel with the exercises and progress tracking features and is not yet active in this release. When it launches, XP will move you through five tiers: Novice, Apprentice, Practitioner, Expert, and Master.",
      },
      {
        q: "How do I delete my account?",
        a: "Go to your Profile page, open the Theme settings section, and scroll to the Danger Zone at the bottom. Click Delete Account and confirm. Deletion is immediate and permanent — all your data is removed with no way to recover it.",
      },
    ],
  },
];
